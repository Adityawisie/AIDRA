...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      <StarsBackground className="absolute inset-0 overflow-hidden pointer-events-none" pointerEvents={false} />

      <div className="max-w-4xl mx-auto text-center rounded-lg border border-white p-6 relative z-20">
        <div className="mb-6">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-foreground mb-8 text-balance">
          AIDRA-Artificial Intelligence Data Retrieving Assistance
        </h1>
